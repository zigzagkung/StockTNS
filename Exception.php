...
/**
 * FWS Inventory  Exception provides details of errors 
 * returned by FWS Inventory  service
 *
 */
class Amazon_FWSInventory_Exception extends Exception

{
    ...
    /**
     * Constructs Amazon_FWSInventory_Exception
    ...
    public function __construct(array $errorInfo = array())
    {
        ...
        if (array_key_exists("Exception", $errorInfo)) {
            ...
            if ($exception instanceof Amazon_FWSInventory_Exception) {
