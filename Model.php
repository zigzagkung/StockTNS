...
/**
 * Amazon_FWSInventory_Model - base class for all model classes
 */ 
abstract class Amazon_FWSInventory_Model
{
    ...
    {
        return preg_match('/^Amazon_FWSInventory_Model_/', $fieldType);
    }
